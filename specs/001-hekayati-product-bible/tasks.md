...
- [x] T-P1-06 [P] Write redaction tests for key patterns, runtime-token canaries, and image bytes, then implement central structured logging safe for later provider/export callers (`src/security/log.ts`) [FR-131 foundation stage, FR-148]
